        ...
        <div class="main-banner" id="home">
            ...
            <header class="header">
                <div class="container-fluid px-lg-5">
                    ...
                    <nav class="py-4">
                        <div id="logo">
                            <h1> <a href="index.html"><span class="fa fa fa-bold" aria-hidden="true"></span>estiBooti</a></h1>
                        </div>
                        ...
                        <ul class="menu mt-2">
                            ...
                            <li><a href="http://facebook.com">Tentang</a></li>
            ...
            <div class="banner-info">
                <p>Produk Paling Laku</p>
                <h3 class="mb-4">Sepatu Kasual Lalaki Jeung Awewe</h3>
                <div class="ban-buttons">
                    <a href="shop-single.html" class="btn">Hayu Balanja Di Die</a>
                    <a href="single.html" class="btn active">Baca Selengkapnya</a>
                </div>
            </div>
            <!--// banner-inner -->
